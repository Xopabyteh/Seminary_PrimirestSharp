...
using Yearly.Infrastructure.Persistence.Repositories.QueryRepositories;
...
public class MenuController : ApiController
{
    ...
    private readonly WeeklyMenuQueryRepository _weeklyMenuQueryRepository;

    public MenuController(IMapper mapper, ISender mediator, IOutputCacheStore outputCacheStore, WeeklyMenuQueryRepository weeklyMenuQueryRepository) 
        : base(mediator)
    {
        _mapper = mapper;
        _outputCacheStore = outputCacheStore;
        _weeklyMenuQueryRepository = weeklyMenuQueryRepository;
    }
    ...
    public async Task<IActionResult> GetAvailableMenus()
    {
        ...
        var response = await _weeklyMenuQueryRepository.GetAvailableMenusDtoAsync();
        return Ok(response);
    }
